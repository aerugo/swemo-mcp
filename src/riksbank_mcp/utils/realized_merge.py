...
from riksbank_mcp.models import ForecastObservation, ForecastVintage, MonetaryPolicyDataResponse
...
def merge_realized(base: ForecastVintage, latest: ForecastVintage) -> ForecastVintage:
    ...
    tail: list[ForecastObservation] = [
        o for o in latest.observations
...
class SeriesFetcher(Protocol):
    async def __call__(self, series_id: str, policy_round: str | None) -> MonetaryPolicyDataResponse: ...
